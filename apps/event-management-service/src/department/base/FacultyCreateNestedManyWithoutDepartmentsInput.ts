...
@InputType()
class FacultyCreateNestedManyWithoutDepartmentsInput {
...
export { FacultyCreateNestedManyWithoutDepartmentsInput as FacultyCreateNestedManyWithoutDepartmentsInput };
