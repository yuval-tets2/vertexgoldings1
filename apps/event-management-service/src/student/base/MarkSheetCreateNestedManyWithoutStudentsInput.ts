...
@InputType()
class MarkSheetCreateNestedManyWithoutStudentsInput {
...
export { MarkSheetCreateNestedManyWithoutStudentsInput as MarkSheetCreateNestedManyWithoutStudentsInput };
